...
class RecuritReportDepartmentResignController extends Controller
{
    ...
    return view('recurit.report.department.resign.index')->withSetting($setting)
                            ->withProject($project)
    ...
    public function ExportPDF(){
        ...
        $pdf->loadView("recurit.report.department.resign.pdfresign" , [ 'reason' => $reason ,'position' => $position , 'resign' => $resign, 'numsection' => $numsection, 'setting' => $setting, 'header' =>  $header ]);
