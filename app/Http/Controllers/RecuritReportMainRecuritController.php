...
class RecuritReportMainRecuritController extends Controller
{
    public function Index(){
        ...
        return view('recurit.report.main.recurit.index')->withProject($project)
    ...
    public function ExportPDF($month,$quater){
        ...
        $pdf->loadView("recurit.report.main.recurit.pdfrecurit" , [ 
