...
class ProjectAllocationDepartmentReadiness extends Controller
{
    public function Index(){
        ...
        return view('project.allocation.department.readiness.index')->withSearch($readiness)
    ...
    public function CreateSave(){
        ...
        return redirect('project/allocation/department/readiness?readiness='. Request::input('readiness_id'))->withSuccess("โอนเงินสำเร็จ");
    }
