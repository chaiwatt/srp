...
class RecuritReportMainResignController extends Controller
{
    ...
    public function Index(){
        ...
        return view('recurit.report.main.resign.index')->withSetting($setting)
                    ->withProject($project)
    ...
    public function ExportPDF(){
        ...
        $pdf->loadView("recurit.report.main.resign.pdfresign" , [ 
