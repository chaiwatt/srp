...
class ReportReadinessSectionController extends Controller
{
    ...
    public function Index(){
        ...
        return view('report.readiness.section.index')->withProject($project)
    ...
    public function ExportSinglePDF($id){
        ...
        $pdf->loadView("report.readiness.section.pdfreadiness" , [ 
