...
class ContractorDepartmentResignController extends Controller
{
  public function Index(){
    ...
    return view('contractor.department.resign.index')->withSetting($setting)
                        ->withProject($project)
  ...
  public function ExportPDF(){
    ...
    $pdf->loadView("contractor.department.resign.pdfresign" , [ 'reason' => $reason ,
                    'position' => $position ,
                    'resign' => $resign, 
