...
class OccupationRefundDepartmentController extends Controller
{
    public function Index(){
        ...
        return view('occupation.refund.department.index')->withProject($project)
    ...
    public function Confirm($id){
        ...
        $new->save();
            ...
            return redirect('occupation/refund/department')->withSuccess("ยืนยันรับคืนเงินสำเร็จ");
    }
