...
class ProjectOccupationMainController extends Controller
{
    public function Index(){
        ...
        return view('occupation.project.main.index')->withProject($project)
    ...
    public function Confirm(){
        ...
        return view('occupation.project.main.confirm')->withProject($project)
                                                    ->withReadiness($readiness);
    }
	...
	public function Approve($id){
        ...
        return redirect('occupation/project/main/confirm')->withSuccess("โครงการอบรมได้อนุมัติแล้ว");
    }
    ...
    public function Edit($id){
        ...
        return view('occupation.project.main.edit')->withProject($project)
                                                ->withReadiness($readiness);
    }
    ...
    public function EditSave(){
        ...
        return redirect('occupation/project/main')->withSuccess("โครงการอบรมได้แก้ไขการจัดสรรแล้ว");
