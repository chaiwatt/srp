...
class ReportOccupationSectionParticipateController extends Controller
{
    public function Index($id){
        ...
        return view('report.occupation.section.participate.index')->withProject($project)
    ...
    public function ExportPDF($id){
      ...
      $pdf->loadView("report.occupation.section.participate.pdfparticipate" , [ 
                                                'project' => $project , 
