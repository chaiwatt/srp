...
class OccupationRefundController extends Controller
{
    ...
    public function Index(){
        ...
        return view('occupation.refund.index')->withProject($project)
        ...
        if(!Empty($department)){
            if( $users->count() > 0 ){
                foreach( $users as $user ){
                    ...
                    $new->project_id = $project->project_id;
                    $new->message_key = 1;
                    $new->message_title = "คืนเงินฝีกอบรมวิชาชีพ";
                    $new->message_content = "คืนเงินฝีกอบรมวิชาชีพ " . $department->department_name ;
                    ...
                    if(!Empty($linenotify)){
                        if ($linenotify->linetoken != ""){
                            $message = "คืนเงินฝีกอบรมวิชาชีพ " . $department->department_name . " โปรดตรวจสอบความถูกต้องจากเว็บไซต์";
