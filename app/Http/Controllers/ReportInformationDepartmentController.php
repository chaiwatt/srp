...
class ReportInformationDepartmentController extends Controller
{
    public function Index(){
        ...
        return view('report.information.department.index')
    ...
    public function ExportPDF($month,$quater,$setyear){
        ...
        $pdf->loadView("report.information.department.pdfinformation" , [ 
    ...
    public function ExportExcel($month,$quater,$setyear){
        ...
        if($month == 0 && $quater == 0){
            ...
            $summary_array[] = array('ประเภทสื่อ','จำนวนที่จัดทำ','จำนวนที่ใช้เงิน','ผู้รับจ้าง');
    ...
    public function ExportWord($month,$quater,$setyear){
        ...
        if($month == 0 && $quater == 0){   
            ...
            $table->addRow(50);
            $table->addCell(4000, $styleCell)->addText(htmlspecialchars('ประเภทสื่อ'), 'headerStyle','pStyle');
            $table->addCell(2500, $styleCell)->addText(htmlspecialchars('จำนวนที่จัดทำ'), 'headerStyle','pStyle');
            $table->addCell(2500, $styleCell)->addText(htmlspecialchars('จำนวนที่ใช้เงิน'), 'headerStyle','pStyle');
            $table->addCell(2500, $styleCell)->addText(htmlspecialchars('	ผู้รับจ้าง'), 'headerStyle','pStyle');        
        ...
        foreach( $expense as $item ){
            $table->addRow(10);
            $table->addCell(4000, $styleCell2)->addText(htmlspecialchars( $item->expense_type ),'bodyStyle','pStyle2');
            $table->addCell(2500, $styleCell2)->addText(htmlspecialchars( $item->expense_amount ),'bodyStyle','pStyle');
            $table->addCell(2500, $styleCell2)->addText(htmlspecialchars( number_format($item->expense_price,2) ),'bodyStyle','pStyle');
            $table->addCell(2500, $styleCell2)->addText(htmlspecialchars( $item->expense_outsource  ),'bodyStyle','pStyle');
        }
