...
class ReadinessProjectSectionController extends Controller
{
    ...
    public function Index(){
        ...
        return view('readiness.project.section.index')->withProject($project)
    ...
    public function List(){
        ...
        return view('readiness.project.section.list')->withProject($project)
                                                    ->withAuth($auth)
                                                    ->withReadinesssection($readinesssection)
                                                    ->withReadiness($readiness);
    ...
    public function Manage($id){
        ...
        return view('readiness.project.section.manage')->withReadiness($readiness)
                                                        ->withSection($section)
                                                        ->withTrainer($trainer)
                                                        ->withCompany($company)
                                                        ->withOfficer($officer)
    ...
    public function ManageSave(){
    	...
    	if( Request::input('actualexpense') == 0 ){
    		return redirect('readiness/project/section/list')->withError("ไม่สามารถบันทึกข้อมูลได้ เนื่องจากไม่ได้กรอกเบิกจ่ายจริง");
        }
    	...
    	if( $transfer == 0 ){
    		return redirect('readiness/project/section/list')->withError("ไม่สามารถบันทึกข้อมูลได้ เนื่องจากไม่มีเงินรับโอน");
        }
        ...
        if( Request::input('actualexpense') > $allocation){
            return redirect('readiness/project/section/list')->withError("ไม่สามารถบันทึกข้อมูลได้ เนื่องจากเงินเบิกจ่ายมากกว่าเงินจัดสรร " );
        }

        if( Request::input('actualexpense') > $remmain){
            return redirect('readiness/project/section/list')->withError("ไม่สามารถบันทึกข้อมูลได้ เนื่องจากเงินรับโอนไม่เพียงพอกับเงินเบิกจ่ายจริง (คงเหลือ " . number_format( ($remmain) , 2 ) . " บาท)" );
        }
        ...
        return redirect('readiness/project/section/list')->withSuccess("บันทึกข้อมูลโครงการสำเร็จ");
    }
    ...
    public function DeleteFile($id){
        ...
        return redirect('readiness/project/section/list' )->withSuccess("ลบไฟล์เอกสารเรียบร้อยแล้ว"); 
    }
    ...
    public function Refund($id){
        ...
        return redirect('readiness/project/section/refundlist')->withSuccess("คืนเงินสำเร็จ");
    ...
    public function RefundList(){
        ...
        return view('readiness.project.section.refund')->withProject($project)
                                                    ->withReadinesssection($readinesssection)
                                                    ->withReadiness($readiness);
