...
class ContractorMainCancelController extends Controller
{
    public function Index(){
        ...
        return view('contractor.main.cancel.index')->withSetting($setting)
                            ->withProject($project)
      ...
      public function ExportPDF(){
        ...
        $pdf->loadView("contractor.main.cancel.pdfcancel" , [ 'reason' => $reason ,
                        'position' => $position ,
                        'resign' => $resign, 
