...
class ContractorDepartmentCancelController extends Controller
{
    public function Index(){
      ...
      return view('contractor.department.cancel.index')->withSetting($setting)
                          ->withProject($project)
    ...
    public function ExportPDF(){
      ...
      $pdf->loadView("contractor.department.cancel.pdfcancel" , [ 'reason' => $reason ,
                      'position' => $position ,
                      'resign' => $resign, 
