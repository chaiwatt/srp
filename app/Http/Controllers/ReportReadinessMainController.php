...
class ReportReadinessMainController extends Controller
{
    public function Index(){
        ...
        if($setyear != ""){
            if(Project::where('year_budget' , $setyear)->get()->count() == 0){
                return redirect('report/readiness/main')->withError("ไม่พบข้อมูลจากปีงบประมาณ " .  $setyear);
            }
        ...
        return view('report.readiness.main.index')->withSetting($setting)
    ...
    public function ExportPDF($month,$quater,$setyear){
        ...
        $pdf->loadView("report.readiness.main.pdfreadiness" , [ 
                            'readiness' => $readiness , 
        ...
        return $pdf->download('readiness.pdf');    
    }
    public function ReadinessChart(){
       ...
       return view('report.readiness.main.readinesschart')->withSetyear($setyear);
