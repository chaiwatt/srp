...
class ContractorDepartmentRecuritController extends Controller
{
    public function Index(){
        ...
        return view('contractor.department.recurit.index')->withProject($project)
    ...
    public function ExportPDF($month,$quater){
        ...
        $pdf->loadView("contractor.department.recurit.pdfrecurit" , [ 
...
public function ExportExcel($month,$quater){
    ...
    $summary_array[] = array('กรมสังกัด','คำนำหน้า','ชื่อ','นามสกุล','เลขประจำตัว','การศึกษา','อายุ','เลขที่จ้างงาน','ตำแหน่ง','เริ่มจ้าง','สิ้นสุดจ้าง'); 
    if(count($employ) > 0){
        foreach( $employ as $item ){
           ...
           if (count($_contractor) !=0 ){
            ...
            ->last();
                ...
                $summary_array[] = array(
                    'department' => $_contractor->departmentname  ,
