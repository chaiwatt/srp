...
class ContractorCancelController extends Controller
{
    public function Index(){
        ...
        return view('contractor.cancel.index')->withProject($project)->withResign($resign);
    }
    ...
    public function CreateSave(){
        ...
        return redirect('contractor/cancel')->withSuccess("บันทึกข้อมูลการลาออกเรียบร้อยแล้ว");
    }
    ...
    public function Create(){
        ...
        return view('contractor.cancel.create')->withProject($project)->withGenerate($generate)->withReason($reason);
