...
class RecuritResignSectionController extends Controller{
    ...
    public function CreateSave(){
        ...
        return redirect('recurit/resign/section')->withSuccess("บันทึกข้อมูลการลาออกเรียบร้อยแล้ว");
    }
    ...
    public function Create(){
        ...
        return view('recurit.resign.section.create')->withProject($project)->withGenerate($generate)->withReason($reason);
    ...
    public function Index(){
        ...
        return view('recurit.resign.section.index')->withProject($project)->withResign($resign);
    }
