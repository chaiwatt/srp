...
class Contractor extends Model
{
    ...
    public function getPositionnameAttribute(){
        $name = "";
        $q = ContractorPosition::where('position_id' , $this->position_id)->first();
        if(count($q) > 0){
    ...
    public function getContractortypenameAttribute(){
        $name = "";
        
        if( $this->contractor_type == 0 ){
            $name = "ยังไม่ได้พิจารณา";
        }
        elseif( $this->contractor_type == 1 ){
            $name = "ผ่านการพิจารณา";
        }
        elseif( $this->contractor_type == 2 ){
  ...
  public function getThaiEndhiredateAttribute()
    ...
    public function getEndhiredateinputThAttribute(){
