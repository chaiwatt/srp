    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="page-title">
                ลาออก : ปีงบประมาณ <?php echo e($project->year_budget); ?> 
            </div>
        </div>
        <div class="col-sm-6">
            <div class="pull-right">
                <a href="<?php echo e(url('recurit/resign/section/create')); ?>" class="btn btn-info">บันทึกลาออก</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="smart-widget widget-dark-blue">
                <div class="smart-widget-header"> รายการลาออก </div>
                                ...
                                <?php $__currentLoopData = $resign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(url('recurit/resign/section/delete/'.$item->resign_id)); ?>" class="btn btn-danger btn-xs" onclick="return confirm('ยืนยันการลบข้อมูล')"><i class="fa fa-remove"></i> ลบ</a>
                                        </td>
                                    </tr>
