    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="page-title">
                โครงการฝึกอบรมเตรียมความพร้อม ปีงบประมาณ : <?php echo e($project->year_budget); ?>
                                        ...
                                        <?php 
                                         ...
                                         ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="<?php echo e(url('readiness/project/main/edit/'.$item->project_readiness_id)); ?>" class="btn btn-info btn-xs">แก้ไขการจัดสรร</a>
                                                </td>
                                            </tr> 
                                        <?php endif; ?>
