...
<ul class="breadcrumb">
        ...
        <li>รายงานรายการเบิกจ่าย</li>    
</ul>

    <div class="row padding-md">
        <div class="col-sm-6">
            <div class="page-title">
                รายงานรายการเบิกจ่าย ปีงบประมาณ : <?php echo e($setting->setting_year); ?> 
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                <?php if( $month != null || $quater != null ): ?>
                    ...
                    <a href="<?php echo e(URL::route('main.budget.export.pdf',['month' => $month , 'quater' => $quater ])); ?>" class="btn btn-sm btn-warning">PDF</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="smart-widget widget-dark-blue">
                <div class="smart-widget-header">รายการเบิกจ่าย
                            ...
                            <tbody>
                                <?php if( count($department) > 0 ): ?>
                                    <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <td class="text-left"><?php echo e($item->department_name); ?></td>
                                            <td class="text-center"><?php echo e($paid); ?></td>
                                            <td class="text-center"><?php echo e($absence); ?></td>
                                            <td class="text-center"><?php echo e($fine); ?></td> 
                                        </tr>
                            ...
                            <?php if( count($department) > 0 ): ?>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo e($payment->sum('payment_salary')); ?></td>
                                        <td class="text-center"><?php echo e($payment->sum('payment_absence')); ?></td>
                                        <td class="text-center"><?php echo e($payment->sum('payment_fine')); ?></td>
                                    </tr>
                                </tfoot>
                            <?php endif; ?>
...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            type:"get",
            url:"<?php echo e(url('api/report/main/budget')); ?>",
            dataType:"Json",
            data:{
                department : "",
            },
