    ...
    <div class="row padding-md">
        <div class="col-sm-9">
            <div class="page-title">
                รายงานอบรมเตรียมความพร้อม ปีงบประมาณ : <?php echo e($setting->setting_year); ?> 
            </div>
        </div>
    </div>
                             ...
                             ?>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo e($total_num); ?></td>
...
<h1><u>แผนภาพรายการฝึกอบรมเตรียมความพร้อม ปีงบประมาณ : <?php echo e($setting->setting_year); ?></u> </h1>
...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            type:"get",
            url:"<?php echo e(url('api/report/main/readiness')); ?>",
            dataType:"Json",
            data:{
                department : "",
            },
