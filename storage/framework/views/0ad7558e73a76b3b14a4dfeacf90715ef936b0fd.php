    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="page-title">
                เพิ่มรายการจัดสรรการจ้างเหมา : ปีงบประมาณ <?php echo e($project->year_budget); ?> 
            </div>
        </div>
    </div>
            ...
            <div class="smart-widget widget-dark-blue">
                ...
                <div class="smart-widget-body">
                    <div class="smart-widget-body  padding-md">
                        <?php echo Form::open([ 'url' => 'contractor/main/employ/create' , 'method' => 'post' ]); ?> 
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" colspan="<?php echo e(count($position)+1); ?>">จำนวนที่จัดสรร</th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <?php if( count($deptallocation) > 0 ): ?>
                                        <?php $__currentLoopData = $deptallocation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                        ...
                                                        <?php if(count($val) > 0): ?>
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="number" min="0" name="number[<?php echo e($item->department_id); ?>][<?php echo e($value->position_id); ?>]" class="form-control text-center" step="1" value="<?php echo e($number); ?>" required />
                                                                </div>
                                                            </td>
                                                        <?php else: ?>
                                                            <td style="display:none;">
                                                                <div class="form-group">
                                                                    <input type="number" min="0" name="number[<?php echo e($item->department_id); ?>][<?php echo e($value->position_id); ?>]" class="form-control" step="1" value="<?php echo e($number); ?>"  />
                                                                </div>
                                                            </td>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
