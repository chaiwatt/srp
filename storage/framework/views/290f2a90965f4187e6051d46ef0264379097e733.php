...
<div class="padding-md">
    ...
    <div class="row padding-md">
        <div class="col-sm-9">
            <div class="page-title">
                    รายการฝึกอบรมวิชาชีพ(รายได้เพียงพอ) ปีงบประมาณ : <?php echo e($setting->setting_year); ?> 
            </div>
        </div>
    </div>
                                 ...
                                 ?>
                                    <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo e($hasoccupation_enoughincome); ?></td>
                                            <?php if($hasoccupation !=0 ): ?>
                                            <td class="text-center"><?php echo e(number_format( ($hasoccupation_enoughincome/ $hasoccupation) * 100 , 2)); ?></td>                                         
                                                <?php else: ?>
                             ...
                             ?>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo e($readiness->count()); ?></td>                                        
                                        <td class="text-center"><?php echo e($totalhasoccupation); ?></td>
                                        <td class="text-center"><?php echo e($totalenoughincome); ?></td>
    ...
    <h1><u>แผนภาพแสดงร้อยละ ฝึกอบรมวิชาชีพ(รายได้เพียงพอ) ปีงบประมาณ : <?php echo e($setting->setting_year); ?> </u></h1>
    <div class="row">
        <div class="col-sm-4">
            <div class="smart-widget widget-dark-blue">
...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            type:"get",
            url:"<?php echo e(url('api/report/main/enoughincome')); ?>",
            dataType:"Json",
            data:{
                department : "",
            },
