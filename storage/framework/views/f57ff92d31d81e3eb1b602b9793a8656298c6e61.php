                                    ...
                                    <?php $__currentLoopData = $readiness; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($item->project_status == 0): ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php if($item->project_status == 0): ?>
                                                        <a href="<?php echo e(url('occupation/project/main/approve/'.$item->project_readiness_id)); ?>" class="btn btn-warning btn-xs" >อนุมัติโครงการ</a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(url('occupation/project/main/edit/'.$item->project_readiness_id)); ?>" class="btn btn-info btn-xs">เพิ่มเติม</a>
                                                </td>
                                            </tr> 
                                        <?php endif; ?>
