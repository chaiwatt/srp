    ...
    <div class="row padding-md">
        <div class="col-sm-6">
            <div class="page-title">
                รายงานรายการลาออก ปีงบประมาณ : <?php echo e($setting->setting_year); ?>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                <?php if( $month != null ): ?>
                    ...
                    <a href="<?php echo e(URL::route('resign.department.export.pdf',['month' => $month ])); ?>" class="btn btn-sm btn-warning">PDF</a>
                        ...
                        <table class="table table-striped">
                                ...
                                <?php if( count($reason) > 0 ): ?>
                                    <?php $__currentLoopData = $reason; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-right"><?php echo e($resign->where('reason_id' , $item->reason_id)->count()); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </tbody>
                            ...
                            <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><strong><?php echo e($resign->count()); ?></strong> </td>
                                    </tr>
                                <?php endif; ?>
                            </tfoot> 
                        </table>
