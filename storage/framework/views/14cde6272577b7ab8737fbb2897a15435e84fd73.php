    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="pull-right">
                <a href="<?php echo e(url('readiness/project/department/create')); ?>" class="btn btn-success"><i class="fa fa-plus"></i> เพิ่มโครงการอบรม</a>
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <?php 
                                     ...
                                     ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php if($item->project_status == 0): ?>
                                                    <a href="<?php echo e(url('readiness/project/department/edit/'.$item->project_readiness_id)); ?>" class="btn btn-info btn-xs" >เพิ่มเติม</a>
                                                    <a href="<?php echo e(url('readiness/project/department/delete/'.$item->project_readiness_id)); ?>" class="btn btn-danger btn-xs" onclick="return confirm('ยืนยันการลบโครงการ')" >ลบ</a>
                                                <?php else: ?>
                                                <a href="<?php echo e(url('readiness/project/department/sectionlist/'.$item->project_readiness_id)); ?>" class="btn btn-info btn-xs" >รายละเอียด</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php 
