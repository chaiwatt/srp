                                ...
                                @if( count($readiness) > 0 )
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td >{{ $item->projectcomplete }}@if ($waitrefund > 0) <span class="text-danger"><a href="{{ url('occupation/project/section/refund/'.$item->readiness_section_id) }}" class="btn btn-danger btn-xs" >คืนเงิน {{$waitrefund}} บาท </a></span> @endif</td>
                                            <td class="text-right"><a href="{{ url('occupation/project/section/manage/'.$item->readiness_section_id) }}" class="btn btn-info" >บันทึก</a></td>                                               
                                        </tr> 
                                    @endforeach
                                @endif
                            </tbody>
