...
@section('content')
{!! Form::open([ 'url' => 'occupation/project/section/manage' , 'method' => 'post' , 'files' => 'true' ]) !!} 
<div class="padding-md">

    <ul class="breadcrumb">
        <li><a href="{{ url('landing') }}">หน้าเว็บไซต์</a></li>
        <li><a href="{{ url('occupation/project/section/list') }}">โครงการฝึกอบรมวิชาชีพ</a></li>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ url('occupation/project/section/deletefile/'.$item->readiness_section_document_id) }}" class="btn btn-danger text-right"><i class="fa fa-remove"></i> ลบ</a> </td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
...
<script type="text/javascript">
    ...
    $("#btnaddregister").click(function(){
            $(function(){
                $.ajax({
                    type:"get",
                    url:"{{ url('occupation/project/section/register') }}",
                    dataType:"Html",
                    data:{
