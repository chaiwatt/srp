...
@section('content')
{!! Form::open([ 'url' => 'readiness/project/department/manage' , 'method' => 'post' , 'files' => 'true' ]) !!} 
<div class="padding-md">

    <ul class="breadcrumb">
        <li><a href="{{ url('landing') }}">หน้าเว็บไซต์</a></li>
        <li><a href="{{ url('readiness/project/department/register') }}">โครงการฝึกอบรมเตรียมความพร้อม</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div id="projectdate"  class="input-append date datepicker" data-provide="datepicker" data-date-language="th-th"">
                                                <input type="text" class="form-control" name="projectdate" readonly="" autocomplete="off" required="">
...
<script type="text/javascript">
    ...
    $(".remove_participategroup").prop("disabled",false);
        ...
        $(".remove_participategroup").click(function(){
            ...
            // if( number_participategroup == 1 ){
            //     $(".remove_participategroup").prop("disabled",true);
            // }
    })    
