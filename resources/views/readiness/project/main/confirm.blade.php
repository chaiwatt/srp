                                    ...
                                    @foreach( $readiness as $item )
                                        @if ($item->project_status == 0)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    @if ($item->project_status == 0)
                                                        <a href="{{ url('readiness/project/main/approve/'.$item->project_readiness_id) }}" class="btn btn-warning btn-xs" >อนุมัติโครงการ</a>
                                                    @endif
                                                    <a href="{{ url('readiness/project/main/edit/'.$item->project_readiness_id) }}" class="btn btn-info btn-xs">เพิ่มเติม</a>
                                                </td>
                                            </tr> 
                                        @endif
                                    @endforeach
