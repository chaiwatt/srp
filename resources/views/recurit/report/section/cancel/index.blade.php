...
<div class="padding-md">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="page-title">
                ยกเลิกจ้างงาน : ปีงบประมาณ {{ $project->year_budget }} 
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                @if( $month != null || $quater != null )
                    <a href="{{ URL::route('recurit.report.section.cancel.export.excel',['month' => $month , 'quater' => $quater ]) }}" class="btn btn-sm btn-info">Excel</a>
                    <a href="{{ URL::route('recurit.report.section.cancel.export.pdf',['month' => $month , 'quater' => $quater ]) }}" class="btn btn-sm btn-warning">PDF</a>
                @endif
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="smart-widget widget-dark-blue">
                <div class="smart-widget-header"> รายการยกเลิกจ้างงาน (เหตุผล) </div>
                <div class="smart-widget-body">
                    <div class="smart-widget-body  padding-md">
                        @if( Session::has('success') )
                            <div class="alert alert-success alert-custom alert-dismissible" role="alert">
