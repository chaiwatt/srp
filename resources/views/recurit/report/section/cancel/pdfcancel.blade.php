...
@section('pdfcontent')
	<div class="container">
		<div class="txt01 txt-center">
			<h1>แบบรายงานสรุปการรายการยกเลิกจ้างงาน</h1>
		</div>
		<div class="txt01 txt-center">
		...
		<div class="txt01">
			<h1>รายการยกเลิกจ้างงาน (เหตุผล)</h1>
		</div>
        <table style="width:100%; " >
            <thead>
                <tr>
            ...
            <tbody>
                ...
                {{-- @php
                    $num = $reason->where('reason_id',$item->reason_id)->count('reson_id');
                @endphp --}}
                    <tr>
