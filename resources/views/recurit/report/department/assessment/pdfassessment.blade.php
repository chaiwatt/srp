        ...
        <table style="width:100%; font-size:14px " >	
            <thead>
                <tr>
                    ...
                    <th  style="font-size:20px " colspan="2" >ความต้องการ</th>
                    <th  style="font-size:20px " colspan="2" >การให้การอบรม</th>
                    <th  style="font-size:20px " rowspan="2">การมอบหมายงาน</th>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                @foreach( $section as $key => $item )
                    <tr>
                        <td  style="font-size:20px " >{{ $item->sectionname }}</td>
                        @php
                            ...
                            ->count();
                        @endphp
                        <td  style="font-size:20px " >{{ $num }}</td>
                        <td  style="font-size:20px " >{{ $scoreavg }}</td>
                        <td  style="font-size:20px " >{{ $occupationneedfit }}</td>
                        <td  style="font-size:20px " >{{ $educationneedfit }}</td>
                        <td  style="font-size:20px " >{{ $occupationtrainfit }}</td>
                        <td  style="font-size:20px " >{{ $educationtrainfit }}</td>
                        <td  style="font-size:20px " >{{ $jobassignmentfit }}</td>
                    </tr>
                @endforeach
                @endif
            </tbody>
