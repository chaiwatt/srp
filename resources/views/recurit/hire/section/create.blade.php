                            ...
                            <tbody>
                                ...
                                @foreach( $register as $key => $item )
                                    <tr> 
                                        ...
                                        <td class="text-right">
                                            <a href="{{ url('recurit/hire/section/createsave/'.$item->register_id.'?generate='.$generate->generate_id) }}" class="btn btn-info" onclick="return confirm('บันทึกข้อมูลจ้างงาน')">บันทึกจ้างงาน</a>
                                        </td>
                                    </tr>
                                @endforeach
                                @endif
