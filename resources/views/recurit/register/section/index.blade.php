    ...
    <div class="row">
        ...
        <div class="col-sm-6">
        	<div class="pull-right">
				<a href="{{ url('recurit/register/section/create') }}" class="btn btn-info">เพิ่ม ผู้สมัครร่วมโครงการ</a>
			</div>
        </div>	
    </div>
	                        ...
	                        <tbody>
								...
								@endphp
	                                <tr>
	                                    ...
	                                    <td class="text-center">{{ $item->prefixname }}</td>
	                                    <td >{{ $item->name }}</td>
	                                    <td >{{ $item->lastname }}</td>
	                                    ...
	                                    <td class="text-right">
	                                    	<a href="{{ url('recurit/register/section/edit/'.$item->register_id) }}" class="btn btn-info btn-xs">เพิ่มเติม</a>
