            ...
            <div class="col-sm-12">
                ...
                <div class="form-inline no-margin">
                    ...
                    @if( $month != null || $quater != null )
                        <a href="{{ URL::route('project.report.main.export.excel',['month' => $month , 'quater' => $quater, 'setyear' => $setyear ]) }}" class="btn btn-sm btn-info">Excel</a>
                        <a href="{{ URL::route('project.report.main.export.pdf',['month' => $month , 'quater' => $quater, 'setyear' => $setyear  ]) }}" class="btn btn-sm btn-warning">PDF</a>
                        <a href="{{ URL::route('project.report.main.export.word',['month' => $month , 'quater' => $quater, 'setyear' => $setyear ]) }}" class="btn btn-sm btn-default">Word</a>
                    @endif
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        @php
                            ...
                            $total_totaltransfer += $totaltransfer;
