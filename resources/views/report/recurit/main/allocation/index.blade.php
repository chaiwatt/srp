                            ...
                            @if( count($department) > 0 )
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-center"><strong>{{ $employ->count() }}</strong> </td>
                                        <td class="text-center"><strong>{{ $resign->where('resign_type',1)->count() }}</strong> </td>
                                        <td class="text-center"><strong> {{ $resign->where('resign_type',2)->count()  }}</strong></td>
                                    </tr>
                                </tfoot>
                            @endif
                        </table>
