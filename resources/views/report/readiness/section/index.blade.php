...
<div class="padding-md">
    ...
    <ul class="breadcrumb">
        ...
        <li>รายงาน ฝึกอบรมเตรียมความพร้อม</li>    
    </ul>

    <div class="row">
        <div class="col-sm-9">
            <div class="page-title">
                    รายงาน ฝึกอบรมเตรียมความพร้อม ปีงบประมาณ : {{ $project->year_budget }}
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="smart-widget widget-dark-blue">
                <div class="smart-widget-header"> รายการ ฝึกอบรมเตรียมความพร้อม</div>
                                ...
                                @if( count($readinesssection) > 0 )
                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="{{ url('report/readiness/section/participate/'.$item->readiness_section_id) }}" class="btn btn-success btn-xs" >ผู้เข้าร่วม</a>
                                                <a href="{{ url('report/readiness/section/pdf/'.$item->readiness_section_id) }}" class="btn btn-info btn-xs" >ดาวน์โหลด</a>
                                            </td>                                               
                                        </tr> 
                                    @endforeach
                                @endif
