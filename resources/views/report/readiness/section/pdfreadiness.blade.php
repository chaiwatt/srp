...
<div style="line-height: 140%;">
		<div class="txt01 txt-center">
			<h1>แบบรายงานสรุปผลการจัดโครงการฝึกอบรมเตรียมความพร้อม</h1>
		</div>
		<div class="txt01 txt-center">
	...
	<div class="container">
        <p style="padding-bottom: -7px;"><span style="display: inline-block; margin-left: 150px">{{ $readinesssection->projectreadinessname }}</span> </p>
        <p style="line-height: 20%;">๑. ชื่อโครงการ....................................................................................................................................................................</p>
        <p style="padding-bottom: -7px;"><span style="display: inline-block; margin-left: 150px">{{ $readinesssection->adddate }}</span> </p>
        <p style="line-height: 20%;">๒. วันที่จัดโครงการ.............................................................................................................................................................</p>
        <p style="padding-bottom: -7px;"><span style="display: inline-block; margin-left: 150px">{{ $section->section_name }}</span>                                                 </p>
		 ...
		 <table style="width:100%; margin-top:15px " class="text-center" >				
            <thead>
                <tr>
                    ...
                    <th  style="width:20%;text-align:center" >จำนวนเข้าร่วม</th>
            ...
            <tbody>
                    ...
                    @foreach( $participate as $key => $item )
                        @if ($item->participate_num !=0 )
                            <tr>
                                ...
                                <td style="text-align:center">{{ $item->participate_num  }}</td>
                            </tr>   
                        @endif
                    @endforeach
                @endif
                @if ($numofficer != 0)
                    ...
                    <td style="text-align:center" >{{ $numofficer }}</td>
                @endif
            </tbody>
        </table>
        ...
        <p style="line-height: 150%;">............................................................................................................................................................................................</p>
        <p style="line-height: 150%;">............................................................................................................................................................................................</p>
        <p style="padding-bottom: -95px;line-height: 130%;"><span style="display: inline-block; margin-left: 150px">{{ $readinesssection->actualexpense }}</span><span style="display: inline-block; margin-left: 150px">{{  $readinesssection->convertcost }}</span>                                                 </p>
        <p >๘. งบประมาณที่ใช้ ............................. บาท (..............................................................................)</p>
        <p >๙. ปัญหา/อุปสรรค </p>
        <p style="width:95%; word-break:break-all; word-wrap:break-word; padding-right:15px; padding-left:15px">{{ $readinesssection->problemdesc }}</p>
        <p >๑๐. ข้อเสนอแนะ </p>
        <p style="width:95%; word-break:break-all; word-wrap:break-word; padding-right:15px; padding-left:15px">{{ $readinesssection->recommenddesc }}</p>
        <p >๑๑. อื่นๆ</p>
        <p >............................................................................................................................................................................................</p>
        <p >............................................................................................................................................................................................</p>
        <p >............................................................................................................................................................................................</p>
