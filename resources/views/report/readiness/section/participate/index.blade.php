...
<div class="padding-md">
    ...
    <ul class="breadcrumb">
        ...
        <li>รายงานฝึกอบรมเตรียมความพร้อม</li>    
    </ul>
    ...
    <div class="row padding-md">
        ...
        <div class="col-sm-3">
            <div class="pull-right">
                ...
                <a href="{{ url('report/readiness/section/participate/excel/'.$readinesssection->readiness_section_id) }}" class="btn btn-info">Excel</a>
                <a href="{{ url('report/readiness/section/participate/pdf/'.$readinesssection->readiness_section_id) }}" class="btn btn-warning">PDF</a>
            </div>
        </div>
    </div> 
{{-- </div> --}}
