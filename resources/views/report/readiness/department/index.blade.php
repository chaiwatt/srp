    ...
    <div class="row padding-md">
        <div class="col-sm-9">
            <div class="page-title">
                รายงานฝึกอบรมและเตรียมความพร้อม ปีงบประมาณ : {{$setyear}} 
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                @if( $month != null || $quater != null )
                    <a href="{{ URL::route('readiness.export.excel',['month' => $month , 'quater' => $quater , 'setyear' => $setyear ]) }}" class="btn btn-sm btn-info">Excel</a>
                    <a href="{{ URL::route('readiness.export.pdf',['month' => $month , 'quater' => $quater , 'setyear' => $setyear ]) }}" class="btn btn-sm btn-warning">PDF</a>
                    <a href="{{ URL::route('readiness.export.word',['month' => $month , 'quater' => $quater , 'setyear' => $setyear ]) }}" class="btn btn-sm btn-default">Word</a>
                @endif
