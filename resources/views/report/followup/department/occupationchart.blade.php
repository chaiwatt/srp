    ...
    <div class="row padding-md">
        <div class="col-sm-9">
            <div class="page-title">
                รายงานการติดตามฝึกอบรมวิชาชีพ ปีงบประมาณ : {{$setting->setting_year}} 
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="smart-widget widget-dark-blue">
                <div class="smart-widget-header"> เปอร์เซนต์ ผู้มีอาชีพหลังฝึกอบรมแยกตามจังหวัด</div>
            ...
            <div class="smart-widget widget-dark-blue">
                <div class="smart-widget-header"> จำนวน ผู้มีอาชีพหลังฝึกอบรมแยกตามหน่วยงาน</div>
                <div class="smart-widget-body">
                    <div class="smart-widget-body  padding-md">
...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            type:"get",
            url:"{{ url('api/report/department/occupationfollowup') }}",
            dataType:"Json",
            data:{
                department : "",
            },
