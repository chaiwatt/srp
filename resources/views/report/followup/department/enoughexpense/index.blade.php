        ...
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                @if( $month != null || $quater != null )
                    <a href="{{ URL::route('followupenoughexpense.export.excel',['month' => $month , 'quater' => $quater , 'setyear' => $setyear ]) }}" class="btn btn-sm btn-info">Excel</a>
                    <a href="{{ URL::route('followupenoughexpense.export.pdf',['month' => $month , 'quater' => $quater , 'setyear' => $setyear ]) }}" class="btn btn-sm btn-warning">PDF</a>
                    <a href="{{ URL::route('followupenoughexpense.export.word',['month' => $month , 'quater' => $quater, 'setyear' => $setyear ]) }}" class="btn btn-sm btn-default">Word</a>
                @endif
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="smart-widget widget-dark-blue">
                <div class="smart-widget-header">ผู้มีรายได้เพียงพอหลังฝึกอบรมอาชีพ(รายได้เพียงพอ)
                            ...
                            @if( count($occupationdatabysection) > 0 )
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-center"><strong>{{ $numproject }}</strong> </td>
                                        <td class="text-center"><strong>{{ $hasoccupation }}</strong> </td>
                                        <td class="text-center"><strong>{{ $totalhasoccupationenoughincome }}</strong> </td>
                                        <td class="text-center"><strong>{{ number_format( ($percent)*100 , 2)  }}</strong> </td>
                                    </tr>
                                </tfoot>
                            @endif
                        </table>
