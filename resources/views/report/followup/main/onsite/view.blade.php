    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="pull-right">
                <a href="{{ url('report/followup/main/onsite/excel/'.$projectfollowup->project_followup_id) }}" class="btn btn-info">Excel</a>
                <a href="{{ url('report/followup/main/onsite/pdf/'.$projectfollowup->project_followup_id) }}" class="btn btn-warning">PDF</a>
            </div>
        </div>
    </div>
</div>
