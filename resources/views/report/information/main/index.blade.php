        ...
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                @if( $month != null || $quater != null )
                    <a href="{{ URL::route('information.main.export.excel',['month' => $month , 'quater' => $quater , 'setyear' => $setyear ]) }}" class="btn btn-sm btn-info">Excel</a>
                    <a href="{{ URL::route('information.main.export.pdf',['month' => $month , 'quater' => $quater , 'setyear' => $setyear]) }}" class="btn btn-sm btn-warning">PDF</a>
                    <a href="{{ URL::route('information.main.export.word',['month' => $month , 'quater' => $quater , 'setyear' => $setyear]) }}" class="btn btn-sm btn-default">Word</a>
                @endif
                ...
                <div class="smart-widget-body">
                    <div class="smart-widget-body  padding-md">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @php
                                    $totalexpense_price = 0;
                                @endphp
                                @if( count($expense) > 0 )
                                @foreach( $expense as $key => $item )
                                @php
                                    $totalexpense_price += $item->expense_price;
                                @endphp
                                    <tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td ><strong>{{ number_format($totalexpense_price,2)  }}</strong></td>                                        
                                </tr>
                            </tfoot>
                        </table>
                    </div>
