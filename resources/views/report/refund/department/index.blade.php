            ...
            <div class="col-sm-12">
                ...
                <div class="form-inline no-margin">
                    ...
                    @if( $month != null || $quater != null )
                        <a href="{{ URL::route('refund.export.excel',['month' => $month , 'quater' => $quater, 'setyear' => $setyear ]) }}" class="btn btn-sm btn-info">Excel</a>
                        <a href="{{ URL::route('refund.export.pdf',['month' => $month , 'quater' => $quater, 'setyear' => $setyear ]) }}" class="btn btn-sm btn-warning">PDF</a>
                        <a href="{{ URL::route('refund.export.word',['month' => $month , 'quater' => $quater, 'setyear' => $setyear ]) }}" class="btn btn-sm btn-default">Word</a>
                    @endif
        ...
        <div class="smart-widget-body">
            <div class="smart-widget-body  padding-md">                
                <table class="table table-striped">
                        ...
                        <tbody>
                            @php
                                $totalrefndprice = $item->refund_price;
                            @endphp
                            @if( count($sectionrefund) > 0 )
                                ...
                                @endphp
                                    <tr>
                                        <td class="text-center">{{ $item->refunddate }}</td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-center"><strong>{{ number_format( $totalrefndprice , 2 ) }}</strong> </td>                                
                            </tr>
                        </tfoot>
                    </table>
            </div>
