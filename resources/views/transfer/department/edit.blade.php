...
<div class="padding-md">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('transfer/department/view/'.$budget->budget_id) }}">ประวัติการโอนงบประมาณ</a></li>
...
<div class="row padding-md">
    <div class="col-md-12">
        ...
        {!! Form::open([ 'url' => 'transfer/department/edit' , 'method' => 'post' ]) !!} 
            ...
            <div class="smart-widget-body">
                <div class="smart-widget-body  padding-md">
	               <div class="form-group">
	                   ...
	                   <input type="text" name="number" class="form-control datepicker" value="{{ $transfer->transfer_price }}" autocomplete="off">
	               </div>
                </div>
            </div>
        </div>
