...
<div class="padding-md">
        ...
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                @if( $month != null || $quater != null )
                    {{-- <a href="{{ URL::route('followup.hasoccupation.export.excel',['month' => $month , 'quater' => $quater ]) }}" class="btn btn-sm btn-info">Excel</a> --}}
                    {{-- <a href="{{ URL::route('followup.hasoccupation.export.pdf',['month' => $month , 'quater' => $quater ]) }}" class="btn btn-sm btn-warning">PDF</a> --}}
                    {{-- <a href="{{ URL::route('followup.hasoccupation.export.word',['month' => $month , 'quater' => $quater ]) }}" class="btn btn-sm btn-default">Word</a> --}}
                @endif
    ...
    <h1><u>แผนภาพแสดง ร้อยละรายการฝึกอบรมวิชาชีพ(มีอาชีพ) ปีงบประมาณ : {{$setting->setting_year}} </u></h1>
    <div class="row">
        <div class="col-sm-4">
            <div class="smart-widget widget-dark-blue">
