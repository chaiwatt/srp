                                ...
                                @foreach( $generate as $key => $item )
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('contractor/payment/create/'.$item->generate_id) }}" class="btn btn-warning">เบิกจ่าย</a>
                                        </td>
                                        <td class="text-center">
                                            <a href="{{ url('contractor/payment/view/'.$item->generate_id) }}" class="btn btn-info">เพิ่มเติม</a>
                                        </td>
                                    </tr>
                                @endforeach
                                @endif
