                ...
                <div class="smart-widget-body">
                    <div class="smart-widget-body  padding-md">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @foreach( $payment as $key => $item )
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->contractorprefixname }}{{ $item->contractorname }} {{ $item->contractorlastname }}</td>
                                        <td >{{ $item->contractorpersonid }}</td>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ url('contractor/payment/list/edit/'.$item->payment_id) }}" class="btn btn-warning btn-xs">แก้ไข</a>
                                            {{-- <a href="{{ url('contractor/payment/section/delete/'.$item->payment_id) }}" class="btn btn-danger btn-xs" onclick="return confirm('ยืนยันการลบข้อมูล')">ลบ</a> --}}
                                        </td>
                                    </tr>
                                @endforeach
                                @endif
                            ...
                            <tfoot>
                                <tr>
                                    <td class="text-right" colspan="5" ><strong>สรุปรายการ</strong> </td>
