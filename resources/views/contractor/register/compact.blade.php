...
<body>
	<div id="wrapper">
		<div class="container">
			...
			<div class="txt01 txt-center">
				<span style="font-size:22px"><strong>ตำแหน่ง <b>{{ $contractor->positionname }}</b></strong></span>
			</div>
			<p style="position: absolute; left: 615px; top: 208px;">{{$contractor->contract_no}}</p>
			<div class="txt01 txt-right">
				<span style="font-size:22px"><strong>ข้อตกลงจ้างเลขที่ ................................</strong></span>
			</div>
			<div style="height:20px"></div>
			{{-- <p style="padding-bottom: -30px; line-height:105%; "><span style="display: inline-block; margin-left: 320px">{{ $contractor->sectionname }}</span> </p> --}}
			<p style="position: absolute; left: 260px; top: 261px;">{{$contractor->departmentname}}</p>
			<p class="text-indent">ข้อตกลงฉบับนี้ทำขึ้น ณ ...............................................................................................................................................</p>
			{{-- <p style="padding-bottom: -50px;line-height:140%; margin-left:20px"><span style="display: inline-block; margin-left: 190px">{{ $contractor->sectionname }}</span> </p> --}}
			<p style="position: absolute; left: 420px; top: 293px;">{{$contractor->departmentname}}</p>
			<p>เมื่อวันที่ ..............................................................................ระหว่าง .......................................................................................................</p>
			{{-- <p style="padding-bottom: -80px;line-height:140%; margin-left:-10px "><span style="display: inline-block; margin-left: 100px">นางสาว สวยเสมอ รักเท่าเทียม</span> <span style="display: inline-block; ; margin-left: 125px">ผู้อำนวยการ</span>                                                 </p> --}}
			<p style="position: absolute; left: 60px; top: 325px;">{{$contractor->representativename}}</p>
			<p style="position: absolute; left: 420px; top: 325px;">{{$contractor->representativeposition}}</p>
			<p>โดย ..................................................................................... ตำแหน่ง .....................................................................................................</p>
			<p>ผู้รับมอบอำนาจจากปลัดกระทรวงยุติธรรม ตามคำสั่งกระทรวงยุติธรรมที่ 1070/02553 ลงวันที่ 5 เมษายน 2553 </p>
			<p>ซึ่งต่อไปในข้อตกลงนี้เรียกว่า “ผู้ว่าจ้าง” ฝ่ายหนึ่ง กับ <b>{{ $contractor->prefixname }}{{ $contractor->name }} {{ $contractor->lastname }}</b> </p>
			<p>อยู่บ้านเลขที่ <b>{{ $contractor->address }}</b> ตำบล <b>{{ $contractor->districtname }}</b> อำเภอ <b>{{ $contractor->amphurname }}</b> จังหวัด <b>{{ $contractor->provincename }}</b> ซึ่งต่อไปในข้อตกลงนี้เรียกว่า “ผู้รับจ้าง” อีกฝ่ายหนึ่ง โดยมีข้อตกลงกันดังต่อไปนี้</p>
			<p class="text-indent bold">ข้อ 1. ข้อตกลงว่าจ้าง</p>
			{{-- <p style="padding-bottom: -30px;"><span style="display: inline-block; margin-left: 530px">พนักงานธุรการ</span> </p> --}}
			<p style="position: absolute; left: 490px; top: 521px;">{{$contractor->positionname}}</p>
			<p class="text-indent">ผู้ว่าจ้างตกลงจ้างและผู้รับจ้างตกลงรับจ้างทำงานให้บริการในตำแหน่ง .....................................................</p>
			{{-- <p style="padding-bottom: -30px;"><span style="display: inline-block; margin-left: 140px">{{ $contractor->sectionname }}</span> </p> --}}
			<p style="position: absolute; left: 150px; top: 553px;">{{$contractor->departmentname}}</p>
			<p>ประจำการ ณ.........................................................................................................................................................................</p>
			{{-- <p style="padding-bottom: -70px;"><span style="display: inline-block; margin-left: 140px">13 มีนาคม 2561</span> <span style="display: inline-block; margin-left: 120px">13 มีนาคม 2561</span> <span style="display: inline-block; margin-left: 130px">400</span></p> --}}
			<p style="position: absolute; left: 150px; top: 584px;">{{$contractor->thaistarthiredate}}</p>
			<p style="position: absolute; left: 350px; top: 584px;"> {{$contractor->thaiendhiredate}}</p>
			<p style="position: absolute; left: 580px; top: 584px;">1</p>
			<p>มีกำหนดตั้งแต่วันที่ ................................................. ถึงวันที่ ................................................. จำนวน .......................... คน			</p>
			<p class="text-indent bold">ข้อที่ 2. การจ่ายค่าจ้าง</p>
			{{-- <p style="padding-bottom: -80px;"><span style="display: inline-block; margin-left: 400px">13 มีนาคม 2561</span> <span style="display: inline-block; margin-left: 80px">13 มีนาคม 2561</span></p> --}}
			<p style="position: absolute; left: 360px; top: 648px;">{{$contractor->thaistarthiredate}}</p>
			<p style="position: absolute; left: 550px; top: 648px;"> {{$contractor->thaiendhiredate}}</p>
			<p class="text-indent">ผู้ว่าจ้างตกลงจ่ายค่าจ้างให้แก่ผู้รับจ้างตั้งแต่ ................................................. ถึง ................................................. </p>
			{{-- <p class="text-indent">ผู้ว่าจ้างตกลงจ่ายค่าจ้างให้แก่ผู้รับจ้างตั้งแต่เดือน .................................... ถึงเดือน ................................... </p> --}}
			{{-- <p style="padding-bottom: -80px;"><span style="display: inline-block; margin-left: 100px">12</span> <span style="display: inline-block; margin-left: 195px">530000</span> <span style="display: inline-block; margin-left: 90px">ห้าแสนสามหมื่นบาทถ้วน</span></p> --}}
			{{-- <p> รวมเป็นเวลา ............... เดือน เป็นจำนวนเงินทั้งสิ้น ......................... บาท (.......................................................................) </p> --}}
			<p style="position: absolute; left: 100px; top: 679px;"> {{$contractor->monthdiff}}</p>
			<p style="position: absolute; left: 365px; top: 679px;"> {{number_format($contractor->contractpayment,2)}}</p>
			<p style="position: absolute; left: 490px; top: 679px;"> {{$contractor->convertobath}}บาทถ้วน</p>
			<p> รวมเป็นเวลา ................................... เดือน เป็นจำนวนเงินทั้งสิ้น ......................... บาท (..................................................................) </p>
			<p> โดยแบ่งจ่ายเป็นรายเดือนตามเดือนแห่งปฏิทิน ในอัตราเดือนละ {{ number_format($position->position_salary , 2) }} บาท และจะจ่ายให้เมื่อผู้รับจ้างได้ให้บริการ ครบในแต่ละเดือนและผู้ว่าจ้างหรือผู้แทนของผู้ว่าจ้างได้ตรวจสอบการให้บริการดังกล่าวเรียบร้อยแล้ว</p>
		...
		<div class="container">
			...
			{{-- <p style="padding-bottom: -30px;"><span style="display: inline-block; margin-left: 120px">นุสรา จันทร์ทากาศ</span> <span style="display: inline-block; margin-left: 235px">นุสรา จันทร์ทากาศ</span> </p> --}}
			...
			{{-- <p style="padding-bottom: -30px;"><span style="display: inline-block; margin-left: 150px">ผู้อำนวยการ</span>  </p> --}}
			...
			{{-- <p style="padding-bottom: -30px;"><span style="display: inline-block; margin-left: 100px">นุสรา จันทร์ทากาศ</span> <span style="display: inline-block; margin-left: 270px">นุสรา จันทร์ทากาศ</span> </p> --}}
		...
		<div class="container">
			<p style="padding-bottom: -30px; margin-left:-20px"><span style="display: inline-block; margin-left: 450px">{{$contractor->position}}</span> </p>
			<p class="txt-center bold">เงื่อนไขและรายละเอียดการจ้างเหมาบริการตำแหน่ง..........................................</p>
			{{-- <p style="padding-bottom: -40px;"><span style="display: inline-block; margin-left: 315px">2573</span> <span style="display: inline-block; margin-left: 20px">2560</span> <span style="display: inline-block; margin-left: 60px">20 กันยายน 2562</span></p> --}}
