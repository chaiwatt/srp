...
<div class="padding-md">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('recurit/cancel/section') }}">ยกเลิก</a></li>
        <li>บันทึกการยกเลิก</li>    
    </ul>
            ...
            <div class="smart-widget widget-dark-blue">
                ...
                <div class="smart-widget-body">
                    <div class="smart-widget-body  padding-md">
                        {!! Form::open([ 'url' => 'contractor/cancel/create' , 'method' => 'post' ]) !!} 
                                ...
                                <select class="form-control" name="generate">
                                    ...
                                    @foreach( $generate as $item )
                                        <option value="{{ $item->generate_id }}">
                                            {{ $item->contractorprefixname }}{{ $item->contractorname }}
                                            {{ $item->contractorlastname }} ( {{ $item->generate_code }} - {{ $item->contractorpositionname }} )
                                        </option>
                                    @endforeach
                                    @endif
                                </select>
