...
<div class="padding-md">
    ...
    <ul class="breadcrumb">
        ...
        <li>รายงานรายการpยกเลิกจ้างงาน</li>    
    </ul>

    <div class="row padding-md">
        <div class="col-sm-6">
            <div class="page-title">
                รายงานรายการยกเลิกจ้างงาน ปีงบประมาณ : {{$setting->setting_year}}
            </div>
        </div>
    </div>
    ...
    <div class="row padding-md pull-right" >
        <div class="col-sm-12">
            ...
            <div class="form-inline no-margin">
                ...
                @if( $month != null )                    
                    <a href="{{ URL::route('contractor.department.cancel.export.pdf',['month' => $month ]) }}" class="btn btn-sm btn-warning">PDF</a>
